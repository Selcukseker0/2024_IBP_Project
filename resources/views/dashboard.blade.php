<x-app-layout>
    ...
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="{{ route('announcements.index') }}"
                        ...
                        <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img" data-id="11980759"
                            data-premium="">
                            <img src="https://cdn-icons-png.flaticon.com/512/11980/11980759.png" width="64"
                                height="64" alt="" title="" class="img-small">
                        </div>
                    ...
                    <a href="{{ route('product.index') }}"
                        class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img" data-id="2652218"
                            data-premium="">
                            <img src="https://cdn-icons-png.flaticon.com/512/2652/2652218.png" width="64"
                                height="64" alt="" title="" class="img-small">
                        </div>
                        ...
                        <div class="flex-1 pl-3">
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black">Product</h2>
                                <p class="mt-4 text-m text-gray-600">Products which are shared by admin to all
                                    users.<br>You can view product by clicking here.</p>
                            </div>
                        </div>
        ...
        <footer>Created By Selçuk Şeker.</footer>
    </div>
