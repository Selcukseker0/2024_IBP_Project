        ...
        <div class="grid gap-15 lg:grid-cols-3 lg:gap-5">
            <div>
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img" data-id="681494"
                        data-premium="">
                        <img src="https://cdn-icons-png.flaticon.com/512/681/681494.png" width="64" height="64"
                            alt="" title="" class="img-small">
                    </div>


                    <div class="pt-3 sm:pt-5">
                        <h2 class="text-xl font-semibold text-black dark:text-white">Editing User Informations</h2>

                        <p class="mt-4 text-m/relaxed">
                            <br>
                            You can edit user informations by clicking here.
                        </p>
                    </div>
            ...
            <div>
                <a href="{{ route('admin.posts.index') }}"
                    ...
                    <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img" data-id="3161837"
                        data-premium="">
                        <img src="https://cdn-icons-png.flaticon.com/512/3161/3161837.png" width="64" height="64"
                            alt="" title="" class="img-small">
                    </div>


                    <div class="pt-3 sm:pt-5">
                        <h2 class="text-xl font-semibold text-black dark:text-white">Sharing Post</h2>

                        <p class="mt-4 text-m/relaxed">
                            You can share post by clicking here.
                            <br>
            ...
            <a href="{{ route('admin.product.index') }}"
                ...
                <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img" data-id="2982808"
                    data-premium="">
                    <img src="https://cdn-icons-png.flaticon.com/512/2982/2982808.png" width="64" height="64"
                        alt="" title="" class="img-small">
                </div>

                <div class="pt-3 sm:pt-5">
                    <h2 class="text-xl font-semibold text-black dark:text-white">Product Control</h2>

                    <p class="mt-4 text-m/relaxed">
                        You can control products by clicking here.
                        <br>
                        You can also add, edit and delete products.
        ...
        <div class="menu">
            <ul>
                <div class="main-icon-without-slide icon-png-container pd-lv4">
                    <a href="https://www.instagram.com/selcuk.seker.0/">
                        <img src="https://cdn-icons-png.flaticon.com/512/174/174855.png" width="64"
                            height="64" alt="İnstagram" title="İnstagram" class="img-small">
                    </a>
                </div>
                <br>
                <div class="main-icon-without-slide icon-png-container pd-lv4">
                    <a href="https://twitter.com/selcukseker0">
                        <img src="https://cdn-icons-png.flaticon.com/512/5968/5968958.png" width="64"
                            height="64" alt="X İkonu" title="X" class="img-small">
                    </a>
                </div>
                <br>
                <div class="main-icon-without-slide icon-png-container pd-lv4">
                    <a href="https://www.linkedin.com/in/sel%C3%A7uk-%C5%9Feker-40805528b/">
                        <img src="https://cdn-icons-png.flaticon.com/512/3536/3536505.png" width="64"
                            height="64" alt="Linkedn İkonu" title="Linkedn" class="img-small">
                    </a>
                </div>
